...
class AIChatViewModel : ViewModel() {
    ...
    2. НЕ ИСПОЛЬЗУЙ символы '*' или '**'. Текст должен быть чистым.
    3. Время и кабинет пиши просто текстом.
    4. Каждое занятие пиши с новой строки. Эмодзи 📍 и ⏰ ставь ОТДЕЛЬНО от текста через пробел.
    5. В конце добавь короткое пожелание на корейском.
